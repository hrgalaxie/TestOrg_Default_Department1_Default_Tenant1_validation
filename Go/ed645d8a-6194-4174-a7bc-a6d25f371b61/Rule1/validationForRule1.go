	...
	import (
		...
		"strconv"
		"strings"
		parser "TestOrg_Default_Department1_Default_Tenant1_validation/Go/ed645d8a-6194-4174-a7bc-a6d25f371b61/Rule1/parser"
...
expression :  bare_nucleoli bland_chromatin EOF ;

bare_nucleoli : BARE_NUCLEOLI ;

bland_chromatin : BLAND_CHROMATIN ;

BARE_NUCLEOLI :SPLITKEY  OWNKEY [0-9]* ;

BLAND_CHROMATIN :SPLITKEY  OWNKEY OWNKEY [0-9]* ;
